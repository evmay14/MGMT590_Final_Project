...
from app.common import (
    apply_borrower_filters, apply_global_style, get_explainability_engine, load_cleaned_dataset,
    render_executive_summary_box, render_missing_artifact_notice, render_page_header, render_section_header,
)
...
if explain_engine is None:
    ...
    with st.spinner("Computing global feature importance..."):
        global_explanation = explain_engine.explain_global_model()
